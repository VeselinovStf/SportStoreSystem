...
using Moq;
using SportStore.Web.Infrastructure.CustomTagHelpers;
using SportStore.Web.ViewModels;
using System.Collections.Generic;
using System.Threading.Tasks;
using Xunit;

namespace SportStore.Tests.WebTests.InfrastructureTests.CustomTagHelpersTests
{
    public class PageLinkTagHelper_Should
    {
        [Fact]
